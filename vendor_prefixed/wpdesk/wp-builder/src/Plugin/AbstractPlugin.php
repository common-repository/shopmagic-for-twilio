 ...
 */
abstract class AbstractPlugin extends \ShopMagicTwilioVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin
{
    /**
    ...
    public function links_filter($links)
    {
        ...
        $plugin_links = ['<a target="_blank" href="' . $support_link . '">' . \esc_html__('Support', 'shopmagic-for-twilio') . '</a>'];
        $links = \array_merge($plugin_links, $links);
        if ($this->docs_url) {
            $plugin_links = ['<a target="_blank" href="' . $this->docs_url . '">' . \esc_html__('Docs', 'shopmagic-for-twilio') . '</a>'];
            $links = \array_merge($plugin_links, $links);
        }
        if ($this->settings_url) {
            $plugin_links = ['<a href="' . $this->settings_url . '">' . \esc_html__('Settings', 'shopmagic-for-twilio') . '</a>'];
            $links = \array_merge($plugin_links, $links);
        }
        return $links;
    }
