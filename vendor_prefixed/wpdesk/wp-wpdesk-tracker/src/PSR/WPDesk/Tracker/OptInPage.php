...
class OptInPage implements \ShopMagicTwilioVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function __construct($plugin_file, $plugin_slug, $shop = null)
    {
        ...
        $this->shop = $shop ?? new \ShopMagicTwilioVendor\WPDesk\Tracker\Shop('');
    }
    ...
    public function output()
    {
        ...
        if (isset($_GET['shop_url'])) {
            $shop = new \ShopMagicTwilioVendor\WPDesk\Tracker\Shop(\sanitize_text_field(\wp_unslash($_GET['shop_url'])));
        } else {
            $shop = $this->shop;
        }
