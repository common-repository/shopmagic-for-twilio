...
class AjaxHandler implements \ShopMagicTwilioVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant
{
    ...
    public function processAjaxNoticeDismiss()
    {
        if (isset($_POST[self::POST_FIELD_NOTICE_NAME])) {
            ...
            $optionName = \ShopMagicTwilioVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_NAME_PREFIX . $noticeName;
            ...
            \update_option($optionName, \ShopMagicTwilioVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_VALUE_DISMISSED);
