...
abstract class ComplianceTollfreeInquiriesOptions
{
     ...
     */
    public static function create(string $businessName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessWebsite = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $useCaseCategories = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $useCaseSummary = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $productionMessageSample = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $optInImageUrls = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $optInType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messageVolume = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessStreetAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessStreetAddress2 = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessCity = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessStateProvinceRegion = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessPostalCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessCountry = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $additionalInformation = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessContactFirstName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessContactLastName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessContactEmail = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessContactPhone = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\CreateComplianceTollfreeInquiriesOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\CreateComplianceTollfreeInquiriesOptions($businessName, $businessWebsite, $useCaseCategories, $useCaseSummary, $productionMessageSample, $optInImageUrls, $optInType, $messageVolume, $businessStreetAddress, $businessStreetAddress2, $businessCity, $businessStateProvinceRegion, $businessPostalCode, $businessCountry, $additionalInformation, $businessContactFirstName, $businessContactLastName, $businessContactEmail, $businessContactPhone);
    }
}
class CreateComplianceTollfreeInquiriesOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $businessName The name of the business or organization using the Tollfree number.
     * @param string $businessWebsite The website of the business or organization using the Tollfree number.
     ...
     * @param string $businessContactPhone The phone number of the contact for the business or organization using the Tollfree number.
     */
    public function __construct(string $businessName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessWebsite = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $useCaseCategories = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $useCaseSummary = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $productionMessageSample = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $optInImageUrls = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $optInType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messageVolume = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessStreetAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessStreetAddress2 = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessCity = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessStateProvinceRegion = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessPostalCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessCountry = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $additionalInformation = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessContactFirstName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessContactLastName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessContactEmail = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $businessContactPhone = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
