 ...
 */
class ComplianceRegistrationInquiriesInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
    ...
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload)
    {
        ...
        $this->properties = ['inquiryId' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'inquiry_id'), 'inquirySessionToken' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'inquiry_session_token'), 'registrationId' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'registration_id'), 'url' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'url')];
        $this->solution = [];
    }
    /**
