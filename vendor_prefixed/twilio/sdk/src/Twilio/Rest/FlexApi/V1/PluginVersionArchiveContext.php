...
class PluginVersionArchiveContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    /**
    ...
    public function update(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginVersionArchiveInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginVersionArchiveInstance($this->version, $payload, $this->solution['pluginSid'], $this->solution['sid']);
    }
    /**
