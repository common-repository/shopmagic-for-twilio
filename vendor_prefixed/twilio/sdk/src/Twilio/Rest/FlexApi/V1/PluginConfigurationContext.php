 ...
 */
class PluginConfigurationContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    protected $_plugins;
    /**
    ...
    public function fetch(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationInstance($this->version, $payload, $this->solution['sid']);
    }
    /**
     * Access the plugins
     */
    ...
    {
        if (!$this->_plugins) {
            $this->_plugins = new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfiguration\ConfiguredPluginList($this->version, $this->solution['sid']);
        }
