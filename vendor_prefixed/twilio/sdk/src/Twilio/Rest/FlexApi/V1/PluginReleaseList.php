...
class PluginReleaseList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(string $configurationId, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginReleaseInstance
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['ConfigurationId' => $configurationId]);
        $headers = \ShopMagicTwilioVendor\Twilio\Values::of(['Flex-Metadata' => $options['flexMetadata']]);
        $payload = $this->version->create('POST', $this->uri, [], $data, $headers);
        return new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginReleaseInstance($this->version, $payload);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginReleasePage
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginReleasePage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return PluginReleasePage Page of PluginReleaseInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginReleasePage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginReleaseContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginReleaseContext($this->version, $sid);
    }
    /**
