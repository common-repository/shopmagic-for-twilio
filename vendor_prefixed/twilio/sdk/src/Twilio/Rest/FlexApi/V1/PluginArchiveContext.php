...
class PluginArchiveContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    /**
    ...
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $sid)
    {
        ...
        $this->uri = '/PluginService/Plugins/' . \rawurlencode($sid) . '/Archive';
    }
    /**
    ...
    public function update(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginArchiveInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginArchiveInstance($this->version, $payload, $this->solution['sid']);
    }
    /**
