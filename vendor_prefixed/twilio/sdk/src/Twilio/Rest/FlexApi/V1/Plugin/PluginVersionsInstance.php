 ...
 */
class PluginVersionsInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, string $pluginSid, string $sid = null)
    {
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\Plugin\PluginVersionsContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\Plugin\PluginVersionsContext($this->version, $this->solution['pluginSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
     ...
     */
    public function fetch(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\Plugin\PluginVersionsInstance
    {
