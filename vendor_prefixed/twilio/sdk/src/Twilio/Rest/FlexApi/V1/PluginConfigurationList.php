...
class PluginConfigurationList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(string $name, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationInstance
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['Name' => $name, 'Plugins' => \ShopMagicTwilioVendor\Twilio\Serialize::map($options['plugins'], function ($e) {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationInstance($this->version, $payload);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationPage
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return PluginConfigurationPage Page of PluginConfigurationInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationContext($this->version, $sid);
    }
    /**
