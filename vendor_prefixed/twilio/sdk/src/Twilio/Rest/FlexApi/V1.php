...
use ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginList;
use ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginArchiveList;
use ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationList;
use ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationArchiveList;
use ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginReleaseList;
use ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginVersionArchiveList;
...
class V1 extends \ShopMagicTwilioVendor\Twilio\Version
{
    ...
    protected function getPlugins() : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginList
    {
        if (!$this->_plugins) {
            $this->_plugins = new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginList($this);
        }
        return $this->_plugins;
    }
    protected function getPluginArchive() : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginArchiveList
    {
        if (!$this->_pluginArchive) {
            $this->_pluginArchive = new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginArchiveList($this);
        }
        return $this->_pluginArchive;
    }
    protected function getPluginConfigurations() : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationList
    {
        if (!$this->_pluginConfigurations) {
            $this->_pluginConfigurations = new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationList($this);
        }
        return $this->_pluginConfigurations;
    }
    protected function getPluginConfigurationArchive() : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationArchiveList
    {
        if (!$this->_pluginConfigurationArchive) {
            $this->_pluginConfigurationArchive = new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginConfigurationArchiveList($this);
        }
        return $this->_pluginConfigurationArchive;
    }
    protected function getPluginReleases() : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginReleaseList
    {
        if (!$this->_pluginReleases) {
            $this->_pluginReleases = new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginReleaseList($this);
        }
        return $this->_pluginReleases;
    }
    protected function getPluginVersionArchive() : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginVersionArchiveList
    {
        if (!$this->_pluginVersionArchive) {
            $this->_pluginVersionArchive = new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\PluginVersionArchiveList($this);
        }
