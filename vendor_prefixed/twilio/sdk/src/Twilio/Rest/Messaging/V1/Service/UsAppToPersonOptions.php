...
abstract class UsAppToPersonOptions
{
     ...
     */
    public static function create(string $optInMessage = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $optOutMessage = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $helpMessage = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $optInKeywords = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $optOutKeywords = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $helpKeywords = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, bool $subscriberOptIn = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $ageGated = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $directLending = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\CreateUsAppToPersonOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\CreateUsAppToPersonOptions($optInMessage, $optOutMessage, $helpMessage, $optInKeywords, $optOutKeywords, $helpKeywords, $subscriberOptIn, $ageGated, $directLending);
    }
}
