...
use ShopMagicTwilioVendor\Twilio\Rest\Numbers\V1\PortingPortInFetchList;
...
class V1 extends \ShopMagicTwilioVendor\Twilio\Version
{
    ...
    protected function getPortingPortInsFetch() : \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V1\PortingPortInFetchList
    {
        if (!$this->_portingPortInsFetch) {
            $this->_portingPortInsFetch = new \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V1\PortingPortInFetchList($this);
        }
