...
abstract class ServiceOptions
{
     ...
     */
    public static function update(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $codeLength = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $lookupEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $skipSmsToLandlines = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $dtmfInputRequired = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $ttsName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $psd2Enabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $doNotShareWarningEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $customCodeEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $pushIncludeDate = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $pushApnCredentialSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pushFcmCredentialSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $totpIssuer = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $totpTimeStep = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $totpCodeLength = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $totpSkew = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $defaultTemplateSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $verifyEventSubscriptionEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\UpdateServiceOptions
    {
...
class CreateServiceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $verifyEventSubscriptionEnabled Whether to allow verifications from the service to reach the stream-events sinks if configured
     */
    public function __construct(int $codeLength = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $lookupEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $skipSmsToLandlines = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $dtmfInputRequired = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $ttsName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $psd2Enabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $doNotShareWarningEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $customCodeEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $pushIncludeDate = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $pushApnCredentialSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pushFcmCredentialSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $totpIssuer = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $totpTimeStep = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $totpCodeLength = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $totpSkew = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $defaultTemplateSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $verifyEventSubscriptionEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
