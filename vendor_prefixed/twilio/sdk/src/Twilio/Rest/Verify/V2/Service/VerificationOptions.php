...
class CreateVerificationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $tags A string containing a JSON map of key value pairs of tags to be recorded as metadata for the message. The object may contain up to 10 tags. Keys and values can each be up to 128 characters in length.
     */
    public function __construct(string $customFriendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $customMessage = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sendDigits = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $locale = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $customCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $amount = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $payee = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $rateLimits = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $channelConfiguration = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $appHash = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $templateSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $templateCustomSubstitutions = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $deviceIp = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $riskCheck = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $tags = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
